...
&nbsp;&nbsp;&nbsp; 사용자 역할(Role)에 따라 시스템 자원(URL, API, 데이터)에 대한 접근 권한을 세밀하게 통제하여 보안성을 강화하였음 <br><br> 
...
* **차등적 활동 권한** <br>
* **강의 게시판** : 강의 수강, 수업 자료 다운로드, 댓글 및 좋아요 작성이 가능하지만, 자료의 보호를 위해 원글 쓰기, 수정, 삭제는 제한됩니다. <br>
* **Q&A 게시판** : 학습 관련 질문 등록이 가능하며, 강사의 전문적인 답변을 보장하기 위해 답글 쓰기 기능은 제한됩니다. <br>
* **커뮤니티** : 수강생 간의 원활한 소통을 위해 모든 게시판 활동(쓰기, 수정, 삭제 등)이 허용됩니다. <br>


* **Role-based Access Control**: `Admin`, `Instructor`, `Student` 등 역할별 접근 제한.
